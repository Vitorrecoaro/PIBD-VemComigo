...
const routes: Routes = [
  ...
  {
    path: 'caronas-disponiveis',
    loadChildren: () => import('./pages/caronas-disponiveis/caronas-disponiveis.module').then( m => m.CaronasDisponiveisPageModule)
  },
  {
    path: 'carona-aceita',
    loadChildren: () => import('./pages/carona-aceita/carona-aceita.module').then( m => m.CaronaAceitaPageModule)
  },
  {
  ...
  {
    path: 'minhas-caronas',
    loadChildren: () => import('./pages/minhas-caronas/minhas-caronas.module').then( m => m.MinhasCaronasPageModule)
  },
  {
    path: 'criar-carona',
    loadChildren: () => import('./pages/criar-carona/criar-carona.module').then( m => m.CriarCaronaPageModule)
  },
  {
    path: 'avaliar-carona',
    loadChildren: () => import('./pages/avaliar-carona/avaliar-carona.module').then( m => m.AvaliarCaronaPageModule)
  },
  {
    path: 'perfil',
